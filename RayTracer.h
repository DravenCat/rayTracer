...
void
calculatePhongModel(struct point3D s, struct ray3D *ray, struct object3D *i, struct object3D *obj, struct point3D *n,
                    double R, double G, double B, struct colourRGB *tmp_col);
